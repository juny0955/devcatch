package com.davcatch.devcatch.schedue.article.parser;
...
import com.davcatch.devcatch.schedue.article.parser.factory.ArticleParseStrategyFactory;
...
public class ArticleParseService {
	...
	private List<ParsedArticle> filterArticles(List<ParsedArticle> articles, Source source) {
		...
		return articles.stream()
			.filter(article -> !articleService.checkExistsLink(article.getLink()))
